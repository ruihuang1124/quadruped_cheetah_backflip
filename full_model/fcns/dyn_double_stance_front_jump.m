function [dXdt,u,GRFF,GRFB] = dyn_double_stance_front_jump(t,X,p)
...
FFy = polyval_bz([50 30 30 20 0], s);
FFx = polyval_bz([-5 -5 0 0 0], s);

FBy = polyval_bz([20 20 10 0 0], s);
FBx = polyval_bz([2 2 2 0 0], s);
